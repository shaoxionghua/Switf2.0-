...
//        let studyController: FirstViewController? = FirstViewController(nibName: "FirstViewController", bundle: nil)
...
//        self.window!.rootViewController = self.navigationController
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.1kf.1kf.SwitfProject01" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SwitfProject01", withExtension: "momd")!
